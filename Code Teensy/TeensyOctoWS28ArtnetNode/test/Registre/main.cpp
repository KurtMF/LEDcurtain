...
// OctoWS2811 settings
const int numPins = 7; // Number of pins used for LED output = 32
//
/*
...
byte pinList[numPins] = {
  5,6,7,13,6,9,32 
//  2, 14, 7, 8, 6, 20, 21, 5
//  24,25,19,18,14,15,17,16,22,23,20,21,26,27
...
const int Led_for_one_strip = 104;
const int Nb_string_strip = 1;
...
// TODO:  WS2811_400kHz ou WS2811_800kHz : 400kHZ =  qui reste toujours blanche (R+G+B+W) ?
